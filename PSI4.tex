...
\begin{document}
    ...
    \section{Struktūrinis dalykinės srities modelis} \label{strukturinisDSModelis}
        ...
        \subsection{Esybių diagrama} \label{strukturinisDSModelis_esybiuDiagrama}
            \begin{figure}[H]
                \centering
                \includegraphics[width=\textwidth, height=20cm, keepaspectratio]{img/ds-modelis_klasiu-diagrama2}
    ...
    \section{Užduotys}\label{uzduotys}
		...
		Taip pat pateikiama bendra UML diagrama apibrėžianti visų šių agentų užduotis.
			...
			\begin{figure}[H]
                \centering
                \includegraphics[width=\textwidth]{img/uzduociu-diagrama}
		...
		\begin{enumerate} [label = \textbf{U\arabic*.}]
			\item \textbf{Užsiregistruoti} \\
				...
				\begin{figure}[H]
					\centering
					\includegraphics[width=\textwidth, height=11cm, keepaspectratio]{img/uzd_registracija}
			...
			\item \textbf{Prisijungti} \\
				...
				\begin{figure}[H]
						\centering
						\includegraphics[width=\textwidth, height=5cm, keepaspectratio]{img/uzd_PrisijungimoLangas}
				...
				\begin{figure}[H]
					\centering
					\includegraphics[width=\textwidth]{img/uzd_perziureti-vyksianciu-renginiu-sarasa}
			...
			\item \textbf{Peržiūrėti preliminarų renginių tvarkaraštį} \\
				...
				\begin{figure}[H]
					\centering
					\includegraphics[width=\textwidth, height=8.5cm, keepaspectratio]{img/uzd_prelim-tvarkarastis}
			...
			\item \textbf{Peržiūrėti preliminarų renginių tvarkaraštį} \\
				...
				\begin{figure}[H]
					\centering
					\includegraphics[width=\textwidth]{img/uzd_konkretusRenginys}
			...
			\item \textbf{Prisijungti prie viešo renginio} \\
				...
				\begin{figure}[H]
					\centering
					\includegraphics[width=\textwidth]{img/uzd_prisijungti-prie-vieso-renginio}
				...
				\begin{figure}[H]
					\centering
					\includegraphics[width=\textwidth]{img/uzd_patikrinti-renginio-organizatoriaus-informacija}
			...
			\item \textbf{Matyti privačius renginius} \\
				...
				\begin{figure}[H]
					\centering
					\includegraphics[width=\textwidth]{img/uzd_matyti-privacius-renginius}
			...
			\item \textbf{Prašyti leidimo dalyvauti privačiame renginyje} \\
				...
				\begin{figure}[H]
					\centering
					\includegraphics[width=\textwidth]{img/uzd_prasymas-dalyvauti-privaciame-renginyje}
			...
			\item \textbf{Peržiūrėti visų renginių tvarkaraštį} \\
				...
				\begin{figure}[H]
					\centering
					\includegraphics[width=\textwidth]{img/uzd_visas-tvarkarastis}
			...
			\item \textbf{Rašyti atsiliepimą apie renginį} \\
				...
				\begin{figure}[H]
					\centering
					\includegraphics[width=\textwidth]{img/uzd_rasyti-atsiliepima-apie-rengini}
			...
			\item \textbf{Peržiūrėti informaciją apie buvusius renginius} \\
				...
				\begin{figure}[H]
					\centering
					\includegraphics[width=\textwidth]{img/uzd_matyti-jau-ivykusius-renginius}
			...
			\item \textbf{Paskelbti apie naują renginį} \\
				...
				\begin{figure}[H]
					\centering
					\includegraphics[width=\textwidth, height=17cm, keepaspectratio]{img/uzd_paskelbti-nauja-rengini}
			...
			\item \textbf{Paskirti naujo renginio atsakingą asmenį} \\
				...
				\begin{figure}[H]
					\centering
					\includegraphics[width=\textwidth]{img/uzd_paskirti-atsakinga-asmeni}
			...
			\item \textbf{Prie renginio pridėti aprašą ir nuotrauką} \\
				...
				\begin{figure}[H]
					\centering
					\includegraphics[width=\textwidth, height=8cm, keepaspectratio]{img/uzd_prideti-aprasa}
			...
			\item \textbf{Ištrinti renginį} \\
				...
				\begin{figure}[H]
					\centering
					\includegraphics[width=\textwidth, height=8cm, keepaspectratio]{img/uzd_istrinti-rengini}
			...
			\item \textbf{Priimti ar atmesti dalyvavimo renginyje prašymą} \\
				...
				\begin{figure}[H]
					\centering
					\includegraphics[width=\textwidth]{img/uzd_priimti-dalyvi}
			...
			\item \textbf{Priimti ar atmesti organizatoriaus paskyrimą} \\
				...
				\begin{figure}[H]
					\centering
					\includegraphics[width=\textwidth]{img/uzd_pasiulymu-sarasas}
			...
			\item \textbf{Atsakyti į dalyvių klausimus}   \\
				...
				\begin{figure}[H]
					\centering
					\includegraphics[width=\textwidth, height=8cm, keepaspectratio]{img/uzd_atsakyti-klausimus}
