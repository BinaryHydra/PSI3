	...
	\section{Testavimo planas ir scenarijai}
		...
		\subsection{Renginių kalendorius}
				...
				\begin{itemize} [noitemsep]
					...
					\item \textbf{Rezultatas:} Kalendoriuje paliekami tik renginiai kuriuose vartotojas dalyvauja. Mygtuko ,,Mano renginiai'' stilius tampa nuspaustu. Likusieji renginiai nera matomi, kol vartotojas dar kartą nepaspaudžia mygtuko ,,Mano renginiai"
				\end{itemize}
