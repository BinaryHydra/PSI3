    ...
    \section{Užduotys}\label{uzduotys}
		...
		\begin{enumerate} [label = \textbf{U\arabic*.}]
			...
			\item \textbf{Keisti komandos sudėtį} \\
				...
				\underline{Alternatyvūs scenarijai:}
				\begin{itemize}
					\item Jei vartotojas spaudžia ,,Priimti'', o pasirinktas vartotojas tuo metu atšaukia prašymą priimti į komandą, pasirinktas vartotojas yra pašalinamas iš sąrašo ir parodomas pranešimas kad vartojas atšaukė pakvietimą.
				\end{itemize}
			...
			\item \textbf{Ištrinti naujienas} \ref{fig:uzd_admin_puslapisNaujienos}\\
