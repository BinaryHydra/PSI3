...
\begin{document}
    ...
    \section{Struktūrinis dalykinės srities modelis} \label{strukturinisDSModelis}
		...
		Žemiau pateikiama matrica (\label{tab:ReikalavimųStruktūrinioModelioAtsekamumoMatrica} lentelė.) atvaizduoja esybių ryšį su reikalavimais pagal kuriuos yra sukurtos esybės.
			\begin{table}[H]
				\centering
    ...
    \section{Užduotys}\label{uzduotys}
		...
		\begin{enumerate} [label = \textbf{U\arabic*.}]
			...
			Žemiau yra pateikiama Reikalavimų - užuočių atsekamamumo matrica (\ref{ReikalavimuUzduociuAtsekamumoMatrica} lentelė.), kurios pagalba, mes nustatome pagal kurį reikalavimą yra sukurta atitinkama užduotis.
			\begin{table}[H]
				\centering
