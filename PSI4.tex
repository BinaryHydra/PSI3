...
\begin{document}
    ...
    \sectionnonum{Įvadas} \label{ivadas}	
        ...
        \subsection*{Darbo tikslas} \label{ivadas_darboTikslas}
            Remiantis ICONIX proceso principais, apibrėžti reikalavimus, struktūrinį srities modelį, užduotis, techninę architektūrą, testavimo planus ir scenarijus sistemai ir parengti sistemos prototipą.
        ...
        \subsection*{Darbo pagrindas} \label{ivadas_pagrindas}
            Dokumentas parengtas kaip programų sistemų inžinerijos laboratorinis darbas ir dokumentacija sistemai.
    ...
    \section{Užduotys}\label{uzduotys}
		...
		\begin{enumerate} [label = \textbf{U\arabic*.}]
			\item \textbf{Skaityti naujienas} (\ref{fig:uzd_skaitymas} pav.)\\
				...
				\begin{figure}[H]
					\centering
					\includegraphics[width=\textwidth]{img/PSI6/U1.jpg}
					\caption{Naujienų skaitymo sekų diagrama}
					\label{draw:u1}
				\end{figure}
			...
			\item \textbf{Peržiūrėti renginių kalendorių} (\ref{fig:uzd_reginioKalendorius} pav.)\\
				...
				\begin{figure}[H]
					\centering
					\includegraphics[width=\textwidth]{img/PSI6/U2.jpg}
					\caption{Renginių kalendoriaus peržiūros sekų diagrama}
					\label{draw:u2}
				\end{figure}	
			...
			\item \textbf{Ieškoti renginio} (\ref{fig:uzd_renginiai} pav.)\\
				...
				\begin{figure}[H]
					\centering
					\includegraphics[width=\textwidth]{img/PSI6/U3.jpg}
					\caption{Renginių ieškojimo sekų diagrama}
					\label{draw:u3}
				\end{figure}
			...
			\item \textbf{Žiūrėti vaizdo įrašus} (\ref{fig:uzd_paleistas_vaizdoIrasas} pav.)\\
				...
				\begin{figure}[H]
					\centering
					\includegraphics[width=\textwidth]{img/PSI6/U4.jpg}
					\caption{Vaizdo įrašų peržiūrėjimo sekų diagrama}
					\label{draw:u4}
				\end{figure}
			...
			\item \textbf{Pateikti renginio pasiūlymą} \\
					...
					\begin{figure}[H]
					\centering
					\includegraphics[width=\textwidth]{img/PSI6/U5.jpg}
					\caption{Renginio pasiūlymo sekų diagrama}
					\label{draw:u5}
				\end{figure}
			...
			\item \textbf{Registracija} (\ref{fig:uzd_registruotis} pav.)\\
					...
					\begin{figure}[H]
					\centering
					\includegraphics[width=\textwidth]{img/PSI6/U6.jpg}
			...
			\item \textbf{Prisijungti} (\ref{fig:uzd_prisijungti} pav.)\\
				...
				\begin{figure}[H]
					\centering
					\includegraphics[width=\textwidth]{img/PSI6/U7.jpg}
			...
			\item \textbf{Pirkti bilietus} \\
				...
				\begin{figure}[H]
					\centering
					\includegraphics[width=\textwidth]{img/PSI6/U8.jpg}
					\caption{Bilietų pirkimo sekų diagrama}
					\label{draw:u8}
				\end{figure}
			...
			\item \textbf{Registracija į renginį} \\
				...
				\begin{figure}[H]
					\centering
					\includegraphics[width=\textwidth]{img/PSI6/U9.jpg}
					\caption{Registracijos į renginį sekų diagrama}
					\label{draw:u9}
				\end{figure}
			...
			\item \textbf{Kurti komandą} (\ref{fig:uzd_registruotiKomanda} pav.)\\
				...
				\begin{figure}[H]
					\centering
					\includegraphics[width=\textwidth]{img/PSI6/U10.jpg}
					\caption{Komandos kūrimo sekų diagrama}
					\label{draw:u10}
				\end{figure}
			...
			\item \textbf{Priimti kvietimą į komandą} \\
				...
				\begin{figure}[H]
					\centering
					\includegraphics[width=\textwidth]{img/PSI6/U11.jpg}
					\caption{Pakvietimo į komandą priėmimo sekų diagrama}
					\label{draw:u11}
				\end{figure}
			...
			\item \textbf{Išeiti iš komandos} \\
				...
				\begin{figure}[H]
					\centering
					\includegraphics[width=\textwidth]{img/PSI6/U12.jpg}
					\caption{Išeijimo iš komandos sekų diagrama}
					\label{draw:u12}
				\end{figure}
			...
			\item \textbf{Pateikti prašymą priimti į komandą} \\
				...
				\begin{figure}[H]
					\centering
					\includegraphics[width=\textwidth]{img/PSI6/U13.jpg}
					\caption{Prašymo priimti į komandą sekų diagrama}
					\label{draw:u13}
				\end{figure}
			...
			\item \textbf{Registruoti komandą į renginį} \\
				...
				\begin{figure}[H]
					\centering
					\includegraphics[width=\textwidth]{img/PSI6/U14.jpg}
					\caption{Komandos registravimo į renginį sekų diagrama}
					\label{draw:u14}
				\end{figure}
			...
			\item \textbf{Aplikuoti į darbo poziciją} \\
				...
				\begin{figure}[H]
					\centering
					\includegraphics[width=\textwidth]{img/PSI6/U15.jpg}
					\caption{Aplikavimo į darbo poziciją sekų diagrama}
					\label{draw:u15}
				\end{figure}
			...
			\item \textbf{Papildyti asmeninę informaciją} \\
				...
				\begin{figure}[H]
					\centering
					\includegraphics[width=\textwidth]{img/PSI6/U16.jpg}
					\caption{Asmeninės informacijos sekų diagrama}
					\label{draw:u16}
				\end{figure}
			...
			\item \textbf{Pašalinti vartotoją iš komandos} \\
					...
					\begin{figure}[H]
						\centering
						\includegraphics[width=\textwidth]{img/PSI6/U17.jpg}
						\caption{Vartotojo pašalinimo iš komandos sekų diagrama}
						\label{draw:u17}
					\end{figure}
			...
			\item \textbf{Pakviesti registruotą vartotoją į komandą}   \\
					...
					\begin{figure}[H]
						\centering
						\includegraphics[width=\textwidth]{img/PSI6/U18.jpg}
						\caption{Registruoto vartotojo pakvietimo į komandą sekų diagrama}
						\label{draw:u18}
					\end{figure}
			...
			\item \textbf{Perleisti komandos vadovo pareigas kitam vartotojui}   \\
					...
					\begin{figure}[H]
						\centering
						\includegraphics[width=\textwidth]{img/PSI6/U19.jpg}
						\caption{Komandos vadovo pareigų perleidimo sekų diagrama}
						\label{draw:u19}
					\end{figure}
				...
				\item \textbf{Sukurti naujieną} (\ref{fig:uzd_org_pridetiNaujienas} pav.)\\
					...
					\begin{figure}[H]
						\centering
						\includegraphics[width=\textwidth]{img/PSI6/U20.jpg}
						\caption{Naujienos sukūrimo sekų diagrama}
						\label{draw:u20}
					\end{figure}
			...
			\item \textbf{Redaguoti naujieną}   \\
					...
					\begin{figure}[H]
						\centering
						\includegraphics[width=\textwidth]{img/PSI6/U21.jpg}
						\caption{Naujienos redagavimo sekų diagrama}
						\label{draw:u21}
					\end{figure}
			...
			\item \textbf{Ištrinti naujieną} (\ref{fig:uzd_admin_puslapisNaujienos} pav.)\\
					...
					\begin{figure}[H]
						\centering
						\includegraphics[width=\textwidth]{img/PSI6/U22.jpg}
						\caption{Naujienos ištrinimo sekų diagrama}
						\label{draw:u22}
					\end{figure}
			...
			\item \textbf{Redaguoti renginį} (\ref{fig:uzd_admin_renginioKalendorius} pav.)\\
					...
					\begin{figure}[H]
						\centering
						\includegraphics[width=\textwidth]{img/PSI6/U23.jpg}
						\caption{Renginio redagavimo sekų diagrama}
						\label{draw:u23}
					\end{figure}
			...
			\item \textbf{Ištrinti renginį}   \\
					...
					\begin{figure}[H]
						\centering
						\includegraphics[width=\textwidth]{img/PSI6/U24.jpg}
						\caption{Renginio ištrinimo sekų diagrama}
						\label{draw:u24}
					\end{figure}
			...
			\item \textbf{Pridėti rezultatus}   \\
					...
					\begin{figure}[H]
						\centering
						\includegraphics[width=\textwidth]{img/PSI6/U25.jpg}
						\caption{Rezultatų pridėjimo sekų diagrama}
						\label{draw:u25}
					\end{figure}
			...
			\item \textbf{Redaguoti rezultatus}   \\
					...
					\begin{figure}[H]
						\centering
						\includegraphics[width=\textwidth]{img/PSI6/U26.jpg}
						\caption{Rezultatų redagavimo sekų diagrama}
						\label{draw:u26}
					\end{figure}
			...
			\item \textbf{Ištrinti rezultatus}   \\
					...
					\begin{figure}[H]
						\centering
						\includegraphics[width=\textwidth]{img/PSI6/U27.jpg}
						\caption{Rezultatų ištrinimo sekų diagrama}
						\label{draw:u27}
					\end{figure}
			...
			\item \textbf{Pridėti vaizdo įrašą} (\ref{fig:uzd_admin_vaizdoIrasas} pav.)\\
					...
					\begin{figure}[H]
						\centering
						\includegraphics[width=\textwidth]{img/PSI6/U28.jpg}
						\caption{Vaizdo įrašų pridėjimo sekų diagrama}
						\label{draw:u28}
					\end{figure}
			...
			\item \textbf{Ištrinti vaizdo įrašą}   \\
					...
					\begin{figure}[H]
						\centering
						\includegraphics[width=\textwidth]{img/PSI6/U29.jpg}
						\caption{Vaizdo įrašų ištrinimo sekų diagrama}
						\label{draw:u29}
					\end{figure}
			...
			\item \textbf{Apriboti, blokuoti, ištrinti vartotojus}   \\
					...
					\begin{figure}[H]
						\centering
						\includegraphics[width=\textwidth]{img/PSI6/U30.jpg}
						\caption{Vartotojų apribojimo, blokavimo, ištrintimo sekų diagrama}
						\label{draw:u30}
					\end{figure}
			...
			\item \textbf{Peržiūrėti darbo aplikacijų sąrašus}   \\
					...
					\begin{figure}[H]
						\centering
						\includegraphics[width=\textwidth]{img/PSI6/U31.jpg}
						\caption{Darbo aplikacijų peržiūros sekų diagrama}
						\label{draw:u31}
					\end{figure}
			...
			\item \textbf{Užregistruoti naują renginį}   \\
					...
					\begin{figure}[H]
						\centering
						\includegraphics[width=\textwidth]{img/PSI6/U32.jpg}
						\caption{Naujo renginio registravimo sekų diagrama}
						\label{draw:u32}
					\end{figure}
			...
			\item \textbf{Peržiūrėti renginio dalyvių sąrašus}   \\
					...
					\begin{figure}[H]
						\centering
						\includegraphics[width=\textwidth]{img/PSI6/U33.jpg}
						\caption{Renginio dalyvių peržiūros sekų diagrama}
						\label{draw:u33}
					\end{figure}
	...
	\section{Testavimo planas ir scenarijai}
		Šiame skyriuje pateikiamas testavimo planas ir į jį įeinantys testavimo scenarijai. Kiekvienam scenarijui pateikiamos tikslas, kurio siekiama vykdant scenarijų, sąlygos - būtina programos būsena prieš pradendant vykdytį testavimo scenarijų, pats testavimo scenarijus - veiksmų seką, kurią reikia įvykdyti norint patikrinti programos teisingą veikimą, ir rezultatas - programos būsena įvykdžius visus testavimo scenarijaus žingsius. Testavimo planai suskirtyti pagal programos langus. Testų scenarijai parašyti taip, kad juos būtų lengva automatizuoti.  
		
		
		\subsection{Vartotojo meniu}
		
				Vartotojo meniu, būnant neprisjungusiu ar prisijungusiu vartotoju, peržiūros lango funkcionalumo testavimo scenarijai. 
		...
		\subsection{Prisijungimo langas}
				...
				Vartotojo prisijungimo būnant neprisjungusiu vartotoju peržiūros lango funkcionalumo testavimo scenarijai. 
				...
				\begin{itemize}	[noitemsep]		
						...
						\item \textbf{Rezultatas:} Parodomi klaidos pranešimai ,,Laukas privalomas'' prie vartotojo vardo ir slaptažodžio laukų.
						\item \textbf{Scenarijus:} Spaudžiame ,,Prisijugti'' nesuvedus dalies duomenų.
						\item \textbf{Rezultatas:} Parodomi klaidos pranešimai ,,Laukas privalomas'' prie neužpildytų laukų.
						\item \textbf{Scenarijus:} Spaudžiame ,,Prisijugti'' suvedus neegzistuojančio vartotojo duomenis.
						\item \textbf{Rezultatas:} Parodomas klaidos pranešimas ,,Vartotojas su tokiu vardu nerastas''.
						\item \textbf{Scenarijus:} Spaudžiame ,,Prisijugti'' suvedus neteisingą vartotojo slaptažodį.
						\item \textbf{Rezultatas:} Parodomas klaidos pranešimas ,,Neteisingas slaptažodis''.
		...
		\subsection{Registracijos langas}	
				...
				Vartotojo registracijos būnant neprisjungusiu vartotoju peržiūros lango funkcionalumo testavimo scenarijai. 
				...
				\begin{itemize}	[noitemsep]		
						...
						\item \textbf{Rezultatas:} Parodomi klaidos pranešimai ,,Laukas privalomas'' prie vartotojo vardo ir slaptažodžių laukų.
						...
						\item \textbf{Rezultatas:} Parodomas klaidos pranešimas ,,Slaptažodžiai nesutapta''.
						...
						\item \textbf{Rezultatas:} Parodomas klaidos pranešimas ,,Vartotojas su tokiu vardu jau egzistuoja''.
						...
						\item \textbf{Rezultatas:} Parodomas klaidos pranešimas ,,Vartotojas su tokiu elektoniniu paštu jau egzistuoja''.
						\item \textbf{Scenarijus:} Spaudžiame ,,Registruotis'' suvedus teisingai užpildę registracijos formą.
		...
		\subsection{Renginių kalendorius}
				...
				Renginių kalendoriaus, būnant neprisjungusiu ar prisijungusiu vartotoju, peržiūros lango funkcionalumo testavimo scenarijai. 
				...
				\begin{itemize} [noitemsep]
						...
						\item \textbf{Scenarijus:} Sukuriamas naujas renginys. Nueinama į renginių kalendoriaus puslapį, pasirenkamas renginio menuo.
				...
				\begin{itemize} [noitemsep]
						...
						\item \textbf{Rezultatas:} Atidaromas pilnas tą dieną vykstačių renginių sąrašas.
				\end{itemize}
		
				\begin{itemize} [noitemsep]
					\item \textbf{Tikslas:} Patikrinti ar kalendorius parodo renginius kuriuose dalyvauje vartotojas 
					\item \textbf{Sąlygos:} Esame prisijunge kaip vartotojas renginių kalendoriaus puslapyje. Sukurtas bent 1 renginys kuriame vartotojas dalyvauja, ir ben vienas kuriame ne.
					\item \textbf{Scenarijus:} Spaudziame mygtuką ,,Mano renginiai''. Kalendoriuje paliekami tik renginiai.
					\item \textbf{Rezultatas:} Kalendoriuje paliekami tik renginiai kuriuose vartotojas dalyvauja. Mygtuko ,,Mano renginiai'' stilius tampa nuspaustu. Likusieji renginiai nėra matomi, kol vartotojas dar kartą nepaspaudžia mygtuko ,,Mano renginiai"
				\end{itemize}

		\subsection{Naujienos}
		
				Naujienų puslapio testavimo scenarijai.

		\begin{itemize} [noitemsep]
				\item \textbf{Tikslas:}Patikrinti ar galima sukurti naujieną.
				\item \textbf{Sąlygos:}Buvimas administratoriumi, ,,Naujienu'' puslapyje.
				\item \textbf{Scenarijus:}Administratorius spaudžia mygtuką ,,Sukurti naujieną''. Atsidariusiame puslapyje, administratorius suveda antraštę, naujienos tekstą, priskiria susijusius renginius, tag'us. Spaudžia mygtuką ,,Sukurti renginį''.
				\item \textbf{Rezultatas:}Sukuriama naujiena, vartotojas nukreipiamas į naujienos puslapį			.
				\item \textbf{Scenarijus:}Administratorius spaudžia mygtuką ,,Sukurti naujieną''. Atsidariusiame puslapyje, administratorius privalomuose laukuose (Naujienos antraste, tekstas) suvedamas trumpesnis nei 5 simbolių tekstas. Spaudžiamas mygtukas ,,Sukurti''.
				\item \textbf{Rezultatas:}Prie atitinkamų laukų parodomi klaidos pranešimai.
		\end{itemize}
				
				\begin{itemize} [noitemsep]
						\item \textbf{Tikslas:} Patikrinti ar tinkamai rodomas naujienų sąrašas. 
						\item \textbf{Sąlygos:} Egzistuoja sukurta bent viena naujiena. 
						\item \textbf{Scenarijus:} Spaudžiamas meniu mygtukas ,,Naujienos", atsidariusiame naujienų lange spaudžiamas naujienos pavadinimas.
						\item \textbf{Rezultatas:} Atidaromas naujienos puslapis.
				\end{itemize}
				
		\subsection{Komandos puslapis} 
		
				Vartotojo nesančio komandos nariu, esančiu komandos nariu arba kapitonu komandos peržiūros lango testavimo scenarijai.
		
				\begin{itemize} [noitemsep]
						\item \textbf{Tikslas:} Patikrinti ar galima sukurti komanda. 
						\item \textbf{Sąlygos:} Buvimas prisjungusiu vartotoju. 
						\item \textbf{Scenarijus:} Spaudžimas mygtukas ,,Mano meniu''. Saraše pasirenkame mygtuką ,,Mano komandos''. Atsidariusiame puslapyje spaudžiama sukurti komandą. Atsidariusiame komandos puslapyje įvedamas komandos pavadinimas, pasirenkami kokius narius bus norima kviesti. Spaudžiamas mygtukas sukurti komandą.
						\item \textbf{Rezultatas:} Sukuriama komanda, pasirinkties nariams išsiunčiamas pakvietimas į komandą, vartotojas nukreipimas į komandos puslapį.
				\end{itemize}
				
				\begin{itemize} [noitemsep]
						\item \textbf{Tikslas:} Patikrinti komandos kūrimo validacija. 
						\item \textbf{Sąlygos:} Buvimas prisjungusiu vartotoju, komandos kurimo puslapyje. 
						\item \textbf{Scenarijus:} Komandos puslapyje įvedamas komandos pavadinimas susidedantis iš mažiau nei 3 simbolių, pasirenkami kokius narius bus norima kviesti. Spaudžiamas mygtukas sukurti komandą.
						\item \textbf{Rezultatas:} Parodomas klaidos pranešimas: ,,Komandos pavadininimas turi susidaryti bent iš 3 simbolių''.
				\end{itemize}
				
				\begin{itemize} [noitemsep]
						\item \textbf{Tikslas:} Patikrinti ne komandos nariui rodomą komandos informaciją. 
						\item \textbf{Sąlygos:} Buvimas prisjungusiu vartotoju, egzistuoja bent 1 komanda, vartotojas nėra jos narys. 
						\item \textbf{Scenarijus:} Atidaromas komandos puslapis.
						\item \textbf{Rezultatas:} Komandos puspalyje rodomas komandos kapitonas, nariai ir pavadinimas, kuriuose renginiuose komanda užėmė prizines vietas.
				\end{itemize}
				
				\begin{itemize} [noitemsep]
						\item \textbf{Tikslas:} Patikrinti ar vartotojas gali išeiti iš komandos. 
						\item \textbf{Sąlygos:} Buvimas prisjungusiu vartotoju, buvimas bent vienoje komandoje ne komandos kapitonu. Buvimas komandos puslapyje.
						\item \textbf{Scenarijus:} Vartotojas spaudžia mygtuką išeiti iš komandos. Atidariusiame patvirtino lange paspaudžia mygtuką patvirtinti.
						\item \textbf{Rezultatas:} Vartotojas pašalimas iš komandos.
				\end{itemize}
				
				\begin{itemize} [noitemsep]
						\item \textbf{Tikslas:} Patikrinti ar komandos kapitonas gali išeiti iš komandos. 
						\item \textbf{Sąlygos:} Buvimas prisjungusiu vartotoju, buvimas bent vienoje komandoje komandos kapitonu. Buvimas komandos puslapyje.
						\item \textbf{Scenarijus:} Vartotojas spaudžia mygtuką išeiti iš komandos. Atidariusiame patvirtino lange komandos kaptionas pasirenka kuriam komandos nariui nori perversti komandos kapitono pareigas ir spaudžia patvirtinti.
						\item \textbf{Rezultatas:} Vartotojas pašalimas iš komandos, nauju komandos kapitonu tampa pasirinktas narys.
				\end{itemize}
				
				\begin{itemize} [noitemsep]
						\item \textbf{Tikslas:} Patikrinti ar komandos kapitonas gali ištrinti komandą. 
						\item \textbf{Sąlygos:} Buvimas prisjungusiu vartotoju, buvimas bent vienoje komandoje komandos kapitonu. Buvimas komandos puslapyje.
						\item \textbf{Scenarijus:} Vartotojas spaudžia mygtuką ištrinti komandą. Atidariusiame patvirtino lange komandos kaptionas pasirenka kuriam komandos nariui nori perversti komandos kaptiono pareigas. Vartotojas pasirenka vartotoja ir spaudžia patvirtinti.
						\item \textbf{Rezultatas:} Vartotojas pašalimas iš komandos, nauju komandos kapitonu tampa pasirinktas narys.
				\end{itemize}
				...
				\begin{itemize} [noitemsep]
						\item \textbf{Tikslas:} Patikrinti ar komandos kapitonas gali ištrinti komandą. 
						\item \textbf{Sąlygos:} Buvimas prisjungusiu vartotoju, buvimas bent vienoje komandoje komandos kapitonu. Buvimas komandos puslapyje.
						\item \textbf{Scenarijus:} Vartotojas spaudžia mygtuką ištrinti komandą. Atsidariusiame patvirtino lange kapitonas spaudžia patvirtiniti ištrinimą.
						\item \textbf{Rezultatas:} Komandos būsena pakeičiama į ištrintą. Ji neberodama komandos nariams prie jų komandų sąrašo. 
				\end{itemize}
				
				
		\subsection{Pakvietimo į komandą peržiūros langas}
		
			Vartotojo pakviesto į komandą, pakvietimų peržiūros lango testavimo scenarijai.
		
				\begin{itemize} [noitemsep]
						\item \textbf{Tikslas:} Patikrinti ar vartojas gali atmesti/ priimti pakvietimą į komanda. 
						\item \textbf{Sąlygos:} Buvimas prisjungusiu vartotoju, turimas bent vienas galiojantis pakvietimas į komandą.
						\item \textbf{Scenarijus:} Vartotojas spaudžia mygtuką pakvietimai. Atsidariusiame pakvietimų į komandą puslapyje pasirenkamas pavietimas, spaudžiama priimti pakvietimą.
						\item \textbf{Rezultatas:} Vartotojas priimamas į komandą, pakvietimas pašalinamas.
						\item \textbf{Scenarijus:} Vartotojas spaudžia mygtuką pakvietimai. Atsidariusiame pakvietimų į komandą puslapyje pasirenkamas pavietimas, spaudžiama atmesti pakvietimą.
						\item \textbf{Rezultatas:} Pakvietimas pašalinamas iš pakvietimų sąrašo. 						
				\end{itemize}
		
		\subsection{Renginio puslapis}
				
				\begin{itemize} [noitemsep]
						\item \textbf{Tikslas:} Patikrinti ar vartojas gali registruoti į renginį. 
						\item \textbf{Sąlygos:} Buvimas prisjungusiu vartotoju, buvimas renginio, kuriame dar nedalyvauja, puslapyje.
						\item \textbf{Scenarijus:} Vartotojas spaudžia mygtuką ,,Registuotis į renginį''.
						\item \textbf{Rezultatas:} Vartotojas įtraukimas į renginio dalyvių sąrašą, mygtukas ,,Registuotis į renginį'' neberodomas. 						
				\end{itemize}
				
					\begin{itemize} [noitemsep]
						\item \textbf{Tikslas:} Patikrinti ar komandos kapitonas gali registruoti komandą į renginį. 
						\item \textbf{Sąlygos:} Buvimas prisjungusiu vartotoju, komandos kapitonu, buvimas renginio, kuriame dar nedalyvauja jo komanda, puslapyje.
						\item \textbf{Scenarijus:} Vartotojas spaudžia mygtuką ,,Registuoti komandą į renginį''. Atsiradusiame lange pasirenkama
						\item \textbf{Rezultatas:} Vartotojas įtraukimas į renginio dalyvių sąrašą, mygtukas ,,Registuotis į renginį'' neberodomas. 						
				\end{itemize}
				
				\begin{itemize} [noitemsep]
						\item \textbf{Tikslas:} Patikrinti ar renginio organizatorius gali redaguoti renginio rezulatatus. 
						\item \textbf{Sąlygos:} Buvimas prisjungusiu vartotoju, renginio organizatoriumi, buvimas renginio, kuri organizuo
						\item \textbf{Scenarijus:} Vartotojas spaudžia mygtuką ,,Registuoti komandą į renginį''. Atsiradusiame lange pasirenkama
						\item \textbf{Rezultatas:} Vartotojas įtraukimas į renginio dalyvių sąrašą, mygtukas ,,Registuotis į renginį'' neberodomas. 						
				\end{itemize}
		...
		\subsection{Bendri atvėjai}
			...
			Testavimo scenarijai taikomi visų langų funkcionalumams.
		
			\begin{itemize} [noitemsep]
					\item \textbf{Tikslas:} Patikrinti prisijungę ar vartotojai gali pasiekti tik jiems pasiekimas funkijas. 
					\item \textbf{Sąlygos:} Esame prisijunge kaip paprastas vartotojas.
					\item \textbf{Scenarijus:} Bandoma į pakeisti adresą į administratoriui tik prieinamo puslapio adresą.
					\item \textbf{Rezultatas:} Vartotojas nukreipiamas į pagrindinį puslapį.
					\item \textbf{Scenarijus:} Bandoma į pakeisti adresą į prisijungimo arba registracijos puslapio adresą.
					\item \textbf{Rezultatas:} Vartotojas nukreipiamas į pagrindinį puslapį.
			\end{itemize}
	
	\section{Prototipas}
	Norint parodyti sistemos įgyvendinamumą pagal pateiktą sistemos aprašą buvo sukurtas sistemos prototipas. Sistemos protipas pasiekimas šiuo adresu: http://theimes-001-site1.ftempurl.com/ 

	\section{Išvados}

	Šio pusmečio labaratorinių darbų metu pagal kitos grupės reikalavimus ir labarotorinius darbus buvo aprašyta sistema ir sukurtas prototipas, taip parodant sistemos įgyvendinamumą ir paruošiant dokumentaciją programuotojams.
